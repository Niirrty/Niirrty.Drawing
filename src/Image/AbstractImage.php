...
use Niirrty\{ ArgumentException, TDisposable, NiirrtyException };
 ...
 * It defines the core code of a {@see \Drawing\Image\IIMage} interface.
 *
 * @since         v0.1
 * @property-read integer               $width
 * @property-read integer               $height
 * @property-read \Niirrty\Drawing\ColorGD[] $usercolors
...
abstract class AbstractImage extends ExplicitGetter implements IImage
{
    ...
    *
    * @return \Niirrty\Drawing\ColorGD[] Array of {@see \Niirrty\Drawing\ColorGD}
    */
    ...
    * @return \Niirrty\Drawing\ColorGD
    ...
    * @throws \Niirrty\ArgumentException
    * @throws \Niirrty\NiirrtyException
    */
   ...
   /**
    * @param  string|\Niirrty\Drawing\ColorGD|\Niirrty\Drawing\Color $color
    * @param  string $name
