...
class Rectangle extends ExplicitGetterSetter
{
    ...
    * Init a new instance.
    *
    * @param \Niirrty\Drawing\Point|null $point
    * @param \Niirrty\Drawing\Size|null  $size
    */
    ...
    *
    * @param  \Niirrty\Drawing\Rectangle $rect
    * @return boolean
    */
    ...
    *
    * @param  int|\Niirrty\Drawing\Point $xOrPoint
    * @param  int|null              $y
    * @return boolean
    */
    ...
    *
    * @param  \Niirrty\Drawing\Size|integer $widthOrSize
    ...
    *
    * @return \Niirrty\Drawing\Rectangle
    */
    ...
    *
    * @param  \Niirrty\Drawing\Rectangle $rect
    * @return \Niirrty\Drawing\Rectangle|false Returns the resulting rectangle or boolean FALSE if no intersection exists.
    */
    ...
    *
    * @param  \Niirrty\Drawing\Rectangle $rect
    * @return \Niirrty\Drawing\Rectangle Returns the resulting rectangle.
    */
    ...
    * @return \Niirrty\Drawing\Rectangle|false
    */
    ...
    * @return \Niirrty\Drawing\Rectangle|false Or boolean FALSE
    */
    ...
    *
    * @param  string                 $value
    * @param  \Niirrty\Drawing\Rectangle &$output
    * @return boolean
    */
