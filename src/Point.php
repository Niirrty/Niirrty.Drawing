...
class Point
{
    ...
    * @return \Niirrty\Drawing\Point|false Returns the resulting point, or boolean FALSE if no usable data are defined.
    */
    ...
    *
    * @param  \Niirrty\Drawing\Point|\Niirrty\Drawing\Rectangle|string|array|\SimpleXMLElement $value
    * @param  \Niirrty\Drawing\Point &$output
    * @return boolean
    */
