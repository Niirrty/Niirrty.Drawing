...
class Size
{
     ...
     *
     * @return Size
     * @throws ArgumentException if $percent is not lower than 100 or if its lower than 1
     */
    ...
    /**
     * Parses a array to a {@see \Niirrty\Drawing\Size} instance.
     *
    ...
    /**
     * Parses a XML element to a {@see \Niirrty\Drawing\Size} instance.
     *
     ...
     * @param Size  $size  Resultierende {@see \Niirrty\Drawing\Size} Instanz
     *
     * @return boolean
     */
    public static function TryParse( $value, ?Size &$size = null ): bool
    {
        ...
        if ( is_resource( $value ) && strContains( get_resource_type( $value ), 'image', true ) )
        {
            try
            {
     ...
     * @param mixed $value
     *
     * @return Size|false Or boolean FALSE
     */
